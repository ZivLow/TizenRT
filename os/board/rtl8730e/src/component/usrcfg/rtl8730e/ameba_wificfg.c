...
_WEAK void wifi_set_user_config(void)
{
	...
	wifi_user_config.softap_keep_silent_table_interval = 80; /* ms. Once interval period is reached, remove from silent table, so can send probe response to same STA again. */
#endif
